...
/*!
 * @file mycobot_TransformComp.cpp
...
class OverwriteInstanceName : public RTM::RtcLifecycleActionListener {
 public:
  OverwriteInstanceName(int argc, char** argv) : m_name(""), m_count(0) {
...
void MyModuleInit(RTC::Manager* manager) {
  ...
  // Create a component
  comp = manager->createComponent("mycobot_Transform");
